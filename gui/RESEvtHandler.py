...
class RESEvtHandler(ogl.ShapeEvtHandler):
    ...
    def OnBeginDragLeft(self, x, y, keys=0, attachment=0):
        ogl.ShapeEvtHandler.OnBeginDragLeft(self, self._shapeX, y, keys, attachment)
        
    def OnDragLeft(self, draw, x, y, keys=0, attachment=0):
        ogl.ShapeEvtHandler.OnDragLeft(self, draw, self._shapeX, y, keys, attachment)
        
    def OnEndDragLeft(self, x, y, keys=0, attachment=0):
        ogl.ShapeEvtHandler.OnEndDragLeft(self, self._shapeX, y, keys, attachment)
