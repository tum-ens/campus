...
class TimeSeriesForm(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = "Time Series", size= wx.Size(300,450))
    ...
    def PopulateData(self, commName, gt, row, col):
        self._lblCommName.SetLabelText(self._lblCommName.GetLabelText() + commName)
        self._lblYear.SetLabelText(self._lblYear.GetLabelText() + gt.GetRowLabelValue(row))
