...
class TransmissionView(wx.Panel):
    ...
    def DrawCommodities(self):
        ...
        for k in sorted(commDict):
            ...
            commShape = res.CommodityShape(self._canvas, x, 10, k, k, data['Color'])
    ...
    def DrawTransmissions(self, lastChangedTrnsm):
        ...
        for k in sorted(transmissions):
            ...
            trnsmShape = res.ProcessShape(self._canvas, x, y, k, t['Name'], 'Trnsm')
    ...
    def BuildConnections(self, trnsmShape, commodities):
        ...
        for comm in commodities:
            ...
            line = res.ConnectionShape(self._canvas, wx.ID_ANY, commShape.GetColor(), True)
            x1, x2 = 0, 0
